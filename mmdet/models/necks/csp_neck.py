...
class CSPNeck(nn.Module):
    ...
    def __init__(self,
        ...
        self.p3 = nn.ConvTranspose2d(in_channels[0], 256, kernel_size=4, stride=2, padding=1)
        self.p4 = nn.ConvTranspose2d(in_channels[1], 256, kernel_size=4, stride=4, padding=0)
        self.p5 = nn.ConvTranspose2d(in_channels[2], 256, kernel_size=4, stride=4, padding=0)
